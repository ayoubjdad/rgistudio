    ...
    <section className={styles.main}>
      <div className={styles.container}>
        ...
        <p className={styles.text}>
          Chez <strong>RGI Studio</strong>, nous transformons vos idées en
          projets concrets. Du print à la communication digitale, en passant par
          le développement web, nous créons des solutions sur mesure pour vous
          aider à vous démarquer et atteindre vos objectifs.
        </p>
        <img
