    ...
    <section className={styles.main}>
      <div className={styles.container}>
        ...
        <p className={styles.text}>
          Les messages et les appels privés vous permettent d’être vous-même, de
          discuter librement et de vous sentir proche des personnes qui comptent
          le plus pour vous, et ce, où qu’elles se trouvent dans le monde.
        </p>
        <img
